...
# Wrapper around the native `AurumNode` class.
#
# In Godot 4.7, GDExtension classes are available as native classes. The
# autoload's `_engine = AurumNode.new()` should instantiate the native class
...
# This file is intentionally minimal. The AurumNode class is provided by
